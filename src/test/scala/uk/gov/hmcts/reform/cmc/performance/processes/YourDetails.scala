...
object YourDetails {
  ...
  def run(implicit postHeaders: Map[String, String]): ChainBuilder = {
    exec(http("TX020_CMC_YourDetail_PartyTypeSelection-GET")
      ...
      .exec(http("TX021_CMC_YourDetail_PartyTypeSelection-POST")
      ...
      .exec(http("TX022_CMC_YourDetail_YourDetails-POST")
        .post(currentPageTemplate)
        .formParam(csrfParameter, csrfTemplate)
      ...
      .exec(http("TX023_CMC_YourDetail_DateOfBirth-POST")
        .post(currentPageTemplate)
        .formParam(csrfParameter, csrfTemplate)
